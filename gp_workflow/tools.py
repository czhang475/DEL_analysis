...
def generate_conformers(molecule, max_confs=200):
    ...
    # print('Max Confs: ', omega.GetMaxConfs())
    # print('Include Input: ', omega.GetIncludeInput())
    # print('Canon Order: ', omega.GetCanonOrder())
    # print('Sample Hydrogens: ', omega.GetSampleHydrogens())
    # print('Energy Window: ', omega.GetEnergyWindow())
    # print('RMS Threshold: ', omega.GetRMSThreshold())
    # print('Strict Stereo: ', omega.GetStrictStereo())
    # print('Strict Atom Types: ', omega.GetStrictAtomTypes())
...
def gen_fp(smiles, fptype=oegraphsim.OEFPType_MACCS166):
    fps = []
    for smi in smiles:
        mol = oechem.OEMol()
